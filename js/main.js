/* ===================================================================
 * Villa dei Gelsi - from Maillard 1.0.0 - Main JS (Optimized)
 * ------------------------------------------------------------------- */

(function(html) {
    'use strict';

    // Caching commonly used selectors
    ...
    const ssSwiper = function() {
        // Configurazione Swiper generale
        const swiperConfig = {
            specialties: {
                slidesPerView: 1,
                breakpoints: {
        ...
        // Specialties slider
        const initSpecialtiesSlider = function() {
        ...
        const initTestimonialSlider = function() {
            ...
            new Swiper(tSlider, swiperConfig.testimonials);
        };
